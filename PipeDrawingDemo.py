...
menu1.add_command(label="导入图片", command=insert_image)
menu1.add_command(label="保 存", command=save)
menu1.add_command(label="退 出", command=root.quit)
menubar.add_cascade(label="文 件", menu=menu1)
"""移动按键区"""
# 坐标图片
